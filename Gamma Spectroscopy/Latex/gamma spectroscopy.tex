...
\begin{figure}[h!]
	\centering
	\scalebox{1}{\input{Figures/Task 1/Risetime.pgf}}
...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 2/Na22.pgf}}
		\caption{}
		\label{fig:1}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 2/Co60.pgf}}
		\caption{}
		\label{fig:2}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 2/Ba133.pgf}}
		\caption{}
		\label{fig:3}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 2/Cs137.pgf}}
		\caption{}
		\label{fig:4}
	\end{subfigure}
...
\begin{figure}[h!]
	\centering
	\scalebox{1}{\input{Figures/Task 2/EnergyCalibration.pgf}}
...
\begin{figure}[h!]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 2/Co60peak.pgf}}
	...
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 2/Co60FWHM.pgf}}
...
\begin{figure}[h!]
	\centering
	\scalebox{1}{\input{Figures/Task 2/AvgCountRate.pgf}}
...
\begin{figure}[h!]
	\centering
	\scalebox{1}{\input{Figures/Task 3/Background.pgf}}
...
\begin{figure}[h!]
	\centering
	\scalebox{1}{\input{Figures/Task 4/Rock.pgf}}
...
\begin{figure}[h!]
	\centering
	\scalebox{1}{\input{Figures/Task 4/Soil.pgf}}
...
\begin{figure}[h!]
	\centering
	\scalebox{1}{\input{Figures/Task 4/Chernobyl.pgf}}
...
\begin{figure}[h!]
	\centering
	\scalebox{1}{\input{Figures/Task 5/V.pgf}}
...
\begin{figure}[h!]
	\centering
	\scalebox{1}{\input{Figures/Task 5/W.pgf}}
...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 1/1.pgf}}
		\caption{FWHM $= 21.53$, $\tau = 0.5 \mu$s }
		\label{fig:1}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 1/2.pgf}}
		\caption{FWHM $= 15.17$, $\tau = 0.8\mu$s}
		\label{fig:2}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 1/3.pgf}}
		\caption{FWHM $= 11.02$ keV, $\tau = 1.2 \ \mu$s.}
		\label{fig:3}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 1/4.pgf}}
		\caption{FWHM $= 6.91$ keV, $\tau = 2.4 \ \mu$s.}
		\label{fig:4}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 1/5.pgf}}
		\caption{FWHM $= 5.54$ keV, $\tau = 3.6 \ \mu$s.}
		\label{fig:5}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 1/6.pgf}}
		\caption{FWHM $= 4.74$ keV, $\tau = 5.6 \ \mu$s.}
		\label{fig:6}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 1/7.pgf}}
		\caption{FWHM $= 4.37$ keV, $\tau = 8.0 \ \mu$s.}
		\label{fig:7}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 1/8.pgf}}
		\caption{FWHM $= 4.31$ keV, $\tau = 10.4 \ \mu$s.}
		\label{fig:8}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.5}{\input{Figures/Task 1/9.pgf}}
