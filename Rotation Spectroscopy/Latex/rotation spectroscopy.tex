...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.50}{\input{Figures/Task 4/Cuvette_dips.pgf}}
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.50}{\input{Figures/Task 4/Cuvette_fit.pgf}}
		\caption{Cuvette fit}
...
\begin{figure}[h!]
	\centering
	\scalebox{0.50}{\input{Figures/Task 5/spectrum.pgf}}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.50}{\input{Figures/Task 5/Quadratic_fit_Cl37.pgf}}
		\caption{$^{37}$Cl}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.50}{\input{Figures/Task 6/original_interpolated_data_p_branch.pgf}}
		\label{fig:original_interpolated_data_p_branch}
	\end{subfigure}
	\hspace{0.5cm}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.50}{\input{Figures/Task 6/intensity_p_branch.pgf}}
...
\begin{figure}[H]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.50}{\input{Figures/Task 6/Cl35_fit.pgf}}
		\caption{$^{35}$Cl}
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\scalebox{0.50}{\input{Figures/Task 6/Cl37_fit.pgf}}
		\caption{$^{37}$Cl}
